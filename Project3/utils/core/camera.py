...
class CameraHelper():
    ...
    def change_angle_by_base(self, azimuth_degree: float, elevation_degree: float):
        self.eye_point.change_azimuth_by_base(azimuth_degree)
        self.eye_point.change_elevation(elevation_degree)
    
    def pan_by_base(self, x: float, y: float):
        self.target_point = self.target_point + self.eye_point.get_panning_vec(x, y)
    ...
    def get_camera_pos(self):
        return self.eye_point.get_eye_point(self.target_point)